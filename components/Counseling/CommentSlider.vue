<template>
  <div class="relative">
    ...
    <div class="flex justify-center gap-3">
      <button
        class="custom-prev right-0 w-12 h-12 bg-secondary text-white rounded-xl flex justify-center items-center transition-all"
      >
        <svg
      ...
      <button
        class="custom-next left-0 w-12 h-12 bg-secondary text-white rounded-xl flex justify-center items-center transition-all"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="1.5em"
