<template>
  <tr class="bg-white">
    ...
    <td class="py-5 px-4">مشاوره تلفنی</td>
    <td class="py-5 px-4">1402/08/26</td>
    <td class="py-5 px-4">09123812637</td>
    <td class="py-5 px-4">
    ...
    <td>
      <div class="card inline-block">
        ...
        >
          ...
          <div
            class="p-3 rounded border bg-[#F7F7F8] max-h-[150px] overflow-auto"
          >
      ...
      >
        <div class="flex gap-2">
          ...
          <div class="text-lg text-black flex flex-col justify-between h-full">
            {{ selectedLawyer }}
            <nuxtLink
              class="text-[9px] md:text-xs block relative top-1.5 md:top-0"
              >وکیل پایه یک کانون وکلای دادگستری</nuxtLink
            >
          </div>
        </div>
...
function removeRequest () {
  ...
  toast.add({
    severity: 'success',
    summary: 'موفقیت آمیز',
    detail: 'درخواست مشاوره با موفقیت رد شد',
    life: 5000
  })
}
</script>
